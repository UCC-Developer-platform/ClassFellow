...
| **Observation #04** | 2026-09-19 | Student Admission | Urdu Name field enforces LTR instead of native RTL BiDi typing. | [`BUG-004`](file:///c:/04_Classfellow/docs/troubleshooting/BUGS_AND_RESOLUTION_REGISTER.md#defect-dossier-004-urdu-text-entry-ltr-vs-rtl-input-flow) (Analyzed) |
| **Observation #05** | 2026-09-19 | Student Admission | "Default Class" dummy dropdown causes blocking "Validation Error". | [`BUG-005`](file:///c:/04_Classfellow/docs/troubleshooting/BUGS_AND_RESOLUTION_REGISTER.md#defect-dossier-005-default-class-dummy-dropdown--missing-inline-class-provisioning-admission-blocker) (Analyzed) |
| **Observation #06** | 2026-09-19 | Navigation Sidebar | Windows DirectWrite ZWJ emoji dissociation (`👨‍🎓` $\rightarrow$ `👨` + `🎓`). | [`BUG-002B`](file:///c:/04_Classfellow/docs/troubleshooting/BUGS_AND_RESOLUTION_REGISTER.md#defect-dossier-002b-multi-codepoint-emoji-dissociation-in-windows-directwrite-font-fallback) (Analyzed) |
