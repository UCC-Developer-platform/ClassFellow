...
#### Recorded Physical Audit Observation Log Entries

| Log Entry | Physical Testing Date | Target Workspace | Discovered Item | Troubleshooting Reference |
| :--- | :---: | :--- | :--- | :--- |
| **Observation #01** | 2026-09-18 | Shell & Navigation | Unmigrated SQLite database crashed Student/Attendance/Exam views. | [`BUG-001`](file:///c:/04_Classfellow/docs/troubleshooting/BUGS_AND_RESOLUTION_REGISTER.md#defect-dossier-001-unmigrated-sqlite-database-on-cold-boot-silent-tab-freeze) (Resolved) |
| **Observation #02** | 2026-09-18 | Navigation Sidebar | Sidebar button horizontal misalignment due to emoji byte width. | [`BUG-002`](file:///c:/04_Classfellow/docs/troubleshooting/BUGS_AND_RESOLUTION_REGISTER.md#defect-dossier-002-sidebar-tab-visual-misalignment) (Resolved) |
| **Observation #03** | 2026-09-18 | Settings Workspace | Settings page cosmetic "ENABLED" green badges ("Fake Indicators"). | [`BUG-003`](file:///c:/04_Classfellow/docs/troubleshooting/BUGS_AND_RESOLUTION_REGISTER.md#defect-dossier-003-cosmetic-fake-indicator-status-on-settings-page) (Resolved) |
| **Observation #04** | 2026-09-19 | Student Admission | Urdu Name field enforces LTR instead of native RTL BiDi typing. | [`BUG-004`](file:///c:/04_Classfellow/docs/troubleshooting/BUGS_AND_RESOLUTION_REGISTER.md#defect-dossier-004-urdu-text-entry-ltr-vs-rtl-input-flow) (Resolved) |
| **Observation #05** | 2026-09-19 | Student Admission | "Default Class" dummy dropdown causes blocking "Validation Error". | [`BUG-005`](file:///c:/04_Classfellow/docs/troubleshooting/BUGS_AND_RESOLUTION_REGISTER.md#defect-dossier-005-default-class-dummy-dropdown--missing-inline-class-provisioning-admission-blocker) (Resolved) |
| **Observation #06** | 2026-09-19 | Navigation Sidebar | Windows DirectWrite ZWJ emoji dissociation (`👨‍🎓` $\rightarrow$ `👨` + `🎓`). | [`BUG-002B`](file:///c:/04_Classfellow/docs/troubleshooting/BUGS_AND_RESOLUTION_REGISTER.md#defect-dossier-002b-multi-codepoint-emoji-dissociation-in-windows-directwrite-font-fallback) (Resolved) |
| **Observation #07** | 2026-09-19 | Student Admission | Monthly discount semantics & collapsible fee schedule redesign. | [`REF-001`](file:///c:/04_Classfellow/docs/troubleshooting/BUGS_AND_RESOLUTION_REGISTER.md#architectural-refinement-ref-001-student-admission-form-fee-redesign--competitor-analysis-strategy) (Held Pending Samples) |
